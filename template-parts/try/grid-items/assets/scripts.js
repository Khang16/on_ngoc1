export const tryGridItems = () => {
  class TryGridItems {
    constructor() {
      console.log("TryGridItems constructor called!"); // Debug
      ...
      console.log("URL params:", { currentUrl, orderby, order, search, category }); // Debug
      ...
      console.log("Container found:", this.container); // Debug
      ...
      this.templateItem = document.getElementById("post-card-template")?.content;
      ...
      this.endpoint = `/wp-json/custom/v1/try/${this.categoryParentSlug}`;
      
      console.log("API endpoint:", this.endpoint); // Debug
      console.log("Category parent slug:", this.categoryParentSlug); // Debug      // Lấy URL hiện tại
      ...
      console.log("Elements check:", {
        ...
        categoryFilterItems: this.categoryFilterItems.length,
    ...
    sortEvent() {
      ...
      this.orderbyFilters.forEach((element) => {
        element.addEventListener("change", (e) => {
          ...
          console.log("Sort changed to:", this.apiParams.order); // Debug
          
          // Cập nhật UI trên desktop
    ...
    template(data, isLoadMore = false) {
      ...
      if (data?.length === 0) {
        ...
        noNews.textContent = "Không tìm thấy bài viết Try phù hợp.";
      ...
      data.forEach(({ link, title, thumbnail, categoryParent, categoryChild, excerpt, date }) => {
        ...
        const titleEl = template.querySelector(".video-card__title a");
        ...
        const ctaEl = template.querySelector(".video-card__cta");
        ...
        videoLabelEl.textContent = "TRY"; // Label riêng cho Try
