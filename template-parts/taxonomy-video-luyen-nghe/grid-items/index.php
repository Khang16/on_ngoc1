...
<section class="grid-items">
    <div class="grid-items__container">
        <div class="grid-items__header">
            <h2 class="grid-items__title">Video Luyện Nghe</h2>
        ...
        <div class="grid-items__grid" id="videoGrid">
            <?php
            if ($videos->have_posts()) {
                while ($videos->have_posts()) {
                    $videos->the_post();
                    get_template_part('template-parts/taxonomy-video-luyen-nghe/grid-items/item-loop');
                }
            } else {
...
<template id="video-card-template">
    <div class="video-card">
        <a href="<?= get_the_permalink() ?>" class="video-card__thumb">
            <img class="video-card__thumb-img" />
