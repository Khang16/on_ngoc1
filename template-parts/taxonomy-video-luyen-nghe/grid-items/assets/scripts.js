export const listeningPracticeVideo = () => {
  class ListenPracticeVideo {
    constructor() {
      ...
      this.endpoint = "/wp-json/custom/v1/extends/video-luyen-nghe";
    ...
    template(data, isLoadMore = false) {
      ...
      data.forEach(({ link, title, thumbnail, categoryParent, categoryChild, excerpt, date }) => {
        ...
        const thumbnailEl = template.querySelector(".video-card__thumb");
